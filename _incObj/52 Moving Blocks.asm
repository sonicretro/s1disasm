...
MBlock_Main:	; Routine 0
		...
		move.w	#make_art_tile(ArtTile_Moving_Block_MZ,2,0),obGfx(a0)
		cmpi.b	#id_LZ,(v_zone).w ; check if level is LZ
		bne.s	loc_FE44
		move.l	#Map_MBlockLZ,obMap(a0) ; LZ specific code
		move.w	#make_art_tile(ArtTile_Moving_Block_LZ,2,0),obGfx(a0)
		move.b	#7,obHeight(a0)

loc_FE44:
		cmpi.b	#id_SBZ,(v_zone).w ; check if level is SBZ
		bne.s	loc_FE60
		move.w	#make_art_tile(ArtTile_Moving_Block_SBZ_Short,1,0),obGfx(a0) ; SBZ specific code (object 5228)
		cmpi.b	#$28,obSubtype(a0) ; is object 5228 ?
		beq.s	loc_FE60	; if yes, branch
		move.w	#make_art_tile(ArtTile_Moving_Block_SBZ_Long,2,0),obGfx(a0) ; SBZ specific code (object 523x)
