...
v_pal_water_dup:	= $FFFFFA00	; duplicate palette data - underwater ($80 bytes)
v_pal_water:	= $FFFFFA80	; duplicate palette data - main ($80 bytes)
v_pal_dry:	= $FFFFFB00	; palette data - underwater ($80 bytes)
v_pal_dry_dup:	= $FFFFFB80	; palette data - main ($80 bytes)
