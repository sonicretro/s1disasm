...
; =================================================================================
v_sndtype:	= $000	; sound type (90=music; 80=waterfall; 70=sound; 68/60=special sound)
...
v_fm0_track:	= $070
v_fm0_playback_control:	= $070	; Playback control bits for FM0
v_fm0_voice_control:	= $071	; Voice control bits
v_fm0_tempo_time:	= $072	; music - tempo dividing timing
v_fm0_ptr:	= $074	; FM channel 0 pointer (4 bytes)
v_fm0_key:	= $078	; FM channel 0 key displacement
v_fm0_volume:	= $079	; FM channel 0 volume attenuation
v_fm0_amsfmspan:	= $07A
v_fm0_voice:	= $07B
v_fm0_stack_ptr:	= $07D
v_fm0_note_timeout:	= $07E	; Counts down to zero; when zero, a new note is needed
v_fm0_note_duration:	= $07F
v_fm0_curr_note:	= $080
v_fm0_note_fill:	= $082
v_fm0_note_fill_master:	= $083
v_fm0_modulation_ptr:	= $084	; 4 bytes
v_fm0_modulation_wait:	= $088
v_fm0_modulation_speed:	= $089
v_fm0_modulation_delta:	= $08A
v_fm0_modulation_steps:	= $08B
v_fm0_modulation_freq:	= $08C	; 2 bytes
v_fm0_freq_adjust:	= $08E
v_fm0_feedbackalgo:	= $08F
v_fm0_loop_index:	= $094	; Several bytes, may overlap with gosub/return stack

v_fm1_track:	= $0A0
v_fm1_playback_control:	= $0A0	; Playback control bits for FM1
v_fm1_voice_control:	= $0A1	; Voice control bits
v_fm1_tempo_time:	= $0A2	; music - tempo dividing timing
v_fm1_ptr:	= $0A4	; FM channel 1 pointer (4 bytes)
v_fm1_key:	= $0A8	; FM channel 1 key displacement
v_fm1_volume:	= $0A9	; FM channel 1 volume attenuation
v_fm1_amsfmspan:	= $0AA
v_fm1_voice:	= $0AB
v_fm1_stack_ptr:	= $0AD
v_fm1_note_timeout:	= $0AE	; Counts down to zero; when zero, a new note is needed
v_fm1_note_duration:	= $0AF
v_fm1_curr_note:	= $0B0
v_fm1_note_fill:	= $0B2
v_fm1_note_fill_master:	= $0B3
v_fm1_modulation_ptr:	= $0B4	; 4 bytes
v_fm1_modulation_wait:	= $0B8
v_fm1_modulation_speed:	= $0B9
v_fm1_modulation_delta:	= $0BA
v_fm1_modulation_steps:	= $0BB
v_fm1_modulation_freq:	= $0BC	; 2 bytes
v_fm1_freq_adjust:	= $0BE
v_fm1_feedbackalgo:	= $0BF
v_fm1_loop_index:	= $0C4	; Several bytes, may overlap with gosub/return stack

v_fm2_track:	= $0D0
v_fm2_playback_control:	= $0D0	; Playback control bits for FM2
v_fm2_voice_control:	= $0D1	; Voice control bits
v_fm2_tempo_time:	= $0D2	; music - tempo dividing timing
v_fm2_ptr:	= $0D4	; FM channel 2 pointer (4 bytes)
v_fm2_key:	= $0D8	; FM channel 2 key displacement
v_fm2_volume:	= $0D9	; FM channel 2 volume attenuation
v_fm2_amsfmspan:	= $0DA
v_fm2_voice:	= $0DB
v_fm2_stack_ptr:	= $0DD
v_fm2_note_timeout:	= $0DE	; Counts down to zero; when zero, a new note is needed
v_fm2_note_duration:	= $0DF
v_fm2_curr_note:	= $0E0
v_fm2_note_fill:	= $0E2
v_fm2_note_fill_master:	= $0E3
v_fm2_modulation_ptr:	= $0E4	; 4 bytes
v_fm2_modulation_wait:	= $0E8
v_fm2_modulation_speed:	= $0E9
v_fm2_modulation_delta:	= $0EA
v_fm2_modulation_steps:	= $0EB
v_fm2_modulation_freq:	= $0EC	; 2 bytes
v_fm2_freq_adjust:	= $0EE
v_fm2_feedbackalgo:	= $0EF
v_fm2_loop_index:	= $0F4	; Several bytes, may overlap with gosub/return stack
...
v_sfx_fm2_track:	= $220
v_sfx_fm2_playback_control:	= $220	; Playback control bits for sfx FM2
v_sfx_fm2_voice_control:	= $221	; Voice control bits
v_sfx_fm2_tempo_time:	= $222	; sfx - tempo dividing timing
v_sfx_fm2_ptr:	= $224	; FM channel 2 pointer (4 bytes)
v_sfx_fm2_key:	= $228	; FM channel 2 key displacement
v_sfx_fm2_volume:	= $229	; FM channel 2 volume attenuation
v_sfx_fm2_amsfmspan:	= $22A
v_sfx_fm2_voice:	= $22B
v_sfx_fm2_stack_ptr:	= $22D
v_sfx_fm2_note_timeout:	= $22E	; Counts down to zero; when zero, a new note is needed
v_sfx_fm2_note_duration:	= $22F
v_sfx_fm2_curr_note:	= $230
v_sfx_fm2_note_fill:	= $232
v_sfx_fm2_note_fill_master:	= $233
v_sfx_fm2_modulation_ptr:	= $234	; 4 bytes
v_sfx_fm2_modulation_wait:	= $238
v_sfx_fm2_modulation_speed:	= $239
v_sfx_fm2_modulation_delta:	= $23A
v_sfx_fm2_modulation_steps:	= $23B
v_sfx_fm2_modulation_freq:	= $23C	; 2 bytes
v_sfx_fm2_freq_adjust:	= $23E
v_sfx_fm2_feedbackalgo:	= $23F
v_sfx_fm2_voice_ptr:	= $240
v_sfx_fm2_loop_index:	= $244	; Several bytes, may overlap with gosub/return stack
