...
; ===========================================================================
	...
	if Revision=0
	; --- Background deformation logic for rev00 ---
	; This one was really basic, aside from Green Hill Zone. Most of it
	; was simply controlling a static background image without any
	; parallax effects. Separating each individual change into an if-else
	; would be a fool's errand, so the following is everything for all zones.
...
; ===========================================================================
	...
	; --- Background deformation logic for rev01 ---
	; This is the biggest difference between the two main revisions, with
	; every level having received a huge background deformation overhaul.
...
; ===========================================================================
	...
	; --- End of main background deformation logic ---
...
locret_6884:
		rts
; End of function BGScroll_Blocks
